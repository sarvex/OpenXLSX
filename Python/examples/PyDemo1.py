...
print(f'Cell A1: ({str(A1.valueType())})', A1.floatValue)
print(f'Cell B1: ({str(B1.valueType())})', B1.integerValue)
print(f'Cell C1: ({str(C1.valueType())})', C1.stringValue)
print(f'Cell D1: ({str(D1.valueType())})', D1.booleanValue)
print(f'Cell E1: ({str(E1.valueType())})', E1.stringValue)
